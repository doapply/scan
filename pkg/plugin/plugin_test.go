...
func TestPlugin_Run(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				Name:        "test_plugin",
				Repository:  "github.com/doapply/search-plugin-test",
				Version:     "0.1.0",
				Usage:       "test",
				Description: "test",
				Platforms: []plugin.Platform{
					{
						...
						URI: "github.com/doapply/search-plugin-test",
						Bin: "test.sh",
					},
				},
				GOOS:   "linux",
		...
		},
		{
			...
			fields: fields{
				Name:        "error_plugin",
				Repository:  "github.com/doapply/search-plugin-error",
				Version:     "0.1.0",
				Usage:       "test",
				Description: "test",
				Platforms: []plugin.Platform{
...
func TestInstall(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantFile: ".search/plugins/test_plugin/test.sh",
		},
		{
...
func TestUninstall(t *testing.T) {
	...
	tempDir := t.TempDir()
	pluginDir := filepath.Join(tempDir, ".search", "plugins", pluginName)
