...
import (
	...
	"github.com/doapply/search/pkg/downloader"
	"github.com/doapply/search/pkg/log"
	"github.com/doapply/search/pkg/utils/fsutils"
)
...
var (
	pluginsRelativeDir = filepath.Join(".search", "plugins")

	officialPlugins = map[string]string{
		"kubectl": "github.com/doapply/search-plugin-kubectl",
		"aqua":    "github.com/doapply/search-plugin-aqua",
	}
)
...
func Install(ctx context.Context, url string, force bool) (Plugin, error) {
	...
	// e.g. kubectl => github.com/doapply/search-plugin-kubectl
