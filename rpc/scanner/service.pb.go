...
// Result is the same as github.com/doapply/search/pkg/report.Result
type Result struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	(*ScanRequest)(nil),                     // 0: search.scanner.v1.ScanRequest
	(*Licenses)(nil),                        // 1: search.scanner.v1.Licenses
	(*ScanOptions)(nil),                     // 2: search.scanner.v1.ScanOptions
	(*ScanResponse)(nil),                    // 3: search.scanner.v1.ScanResponse
	(*Result)(nil),                          // 4: search.scanner.v1.Result
	nil,                                     // 5: search.scanner.v1.ScanOptions.LicenseCategoriesEntry
	(*common.OS)(nil),                       // 6: search.common.OS
	(*common.Vulnerability)(nil),            // 7: search.common.Vulnerability
	(*common.DetectedMisconfiguration)(nil), // 8: search.common.DetectedMisconfiguration
	(*common.Package)(nil),                  // 9: search.common.Package
	(*common.CustomResource)(nil),           // 10: search.common.CustomResource
	(*common.SecretFinding)(nil),            // 11: search.common.SecretFinding
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	2,  // 0: search.scanner.v1.ScanRequest.options:type_name -> search.scanner.v1.ScanOptions
	5,  // 1: search.scanner.v1.ScanOptions.license_categories:type_name -> search.scanner.v1.ScanOptions.LicenseCategoriesEntry
	6,  // 2: search.scanner.v1.ScanResponse.os:type_name -> search.common.OS
	4,  // 3: search.scanner.v1.ScanResponse.results:type_name -> search.scanner.v1.Result
	7,  // 4: search.scanner.v1.Result.vulnerabilities:type_name -> search.common.Vulnerability
	8,  // 5: search.scanner.v1.Result.misconfigurations:type_name -> search.common.DetectedMisconfiguration
	9,  // 6: search.scanner.v1.Result.packages:type_name -> search.common.Package
	10, // 7: search.scanner.v1.Result.custom_resources:type_name -> search.common.CustomResource
	11, // 8: search.scanner.v1.Result.secrets:type_name -> search.common.SecretFinding
	1,  // 9: search.scanner.v1.ScanOptions.LicenseCategoriesEntry.value:type_name -> search.scanner.v1.Licenses
	0,  // 10: search.scanner.v1.Scanner.Scan:input_type -> search.scanner.v1.ScanRequest
	3,  // 11: search.scanner.v1.Scanner.Scan:output_type -> search.scanner.v1.ScanResponse
