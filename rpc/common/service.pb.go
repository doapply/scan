...
type DetectedMisconfiguration struct {
	...
	Severity    Severity `protobuf:"varint,8,opt,name=severity,proto3,enum=search.common.Severity" json:"severity,omitempty"`
...
type Vulnerability struct {
	...
	Severity           Severity               `protobuf:"varint,7,opt,name=severity,proto3,enum=search.common.Severity" json:"severity,omitempty"`
	...
	VendorSeverity     map[string]Severity    `protobuf:"bytes,21,rep,name=vendor_severity,json=vendorSeverity,proto3" json:"vendor_severity,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=search.common.Severity"`
...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x52, 0x09, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x69, 0x65, 0x73, 0x22, 0xa0, 0x03,
	...
	0x65, 0x72, 0x22, 0xa3, 0x09, 0x0a, 0x0d, 0x56, 0x75, 0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69,
	...
	0x74, 0x65, 0x64, 0x42, 0x79, 0x22, 0x76, 0x0a, 0x04, 0x43, 0x56, 0x53, 0x53, 0x12, 0x1b, 0x0a,
	...
	0x75, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf3, 0x01, 0x0a, 0x04, 0x4c, 0x69, 0x6e,
	...
	0x65, 0x6e, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x63, 0x61, 0x75, 0x73, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x43, 0x61, 0x75, 0x73, 0x65, 0x12, 0x1e,
	...
	,
	...
	0x73, 0x2a, 0x44, 0x0a, 0x08, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x0b, 0x0a,
...
var file_rpc_common_service_proto_goTypes = []interface{}{
	(Severity)(0),                    // 0: search.common.Severity
	(*OS)(nil),                       // 1: search.common.OS
	(*Repository)(nil),               // 2: search.common.Repository
	(*PackageInfo)(nil),              // 3: search.common.PackageInfo
	(*Application)(nil),              // 4: search.common.Application
	(*Package)(nil),                  // 5: search.common.Package
	(*Misconfiguration)(nil),         // 6: search.common.Misconfiguration
	(*MisconfResult)(nil),            // 7: search.common.MisconfResult
	(*DetectedMisconfiguration)(nil), // 8: search.common.DetectedMisconfiguration
	(*Vulnerability)(nil),            // 9: search.common.Vulnerability
	(*DataSource)(nil),               // 10: search.common.DataSource
	(*Layer)(nil),                    // 11: search.common.Layer
	(*CVSS)(nil),                     // 12: search.common.CVSS
	(*CustomResource)(nil),           // 13: search.common.CustomResource
	(*Line)(nil),                     // 14: search.common.Line
	(*Code)(nil),                     // 15: search.common.Code
	(*SecretFinding)(nil),            // 16: search.common.SecretFinding
	(*Secret)(nil),                   // 17: search.common.Secret
	nil,                              // 18: search.common.Vulnerability.CvssEntry
	nil,                              // 19: search.common.Vulnerability.VendorSeverityEntry
	(*timestamppb.Timestamp)(nil),    // 20: google.protobuf.Timestamp
	(*structpb.Value)(nil),           // 21: google.protobuf.Value
}
var file_rpc_common_service_proto_depIdxs = []int32{
	5,  // 0: search.common.PackageInfo.packages:type_name -> search.common.Package
	5,  // 1: search.common.Application.libraries:type_name -> search.common.Package
	11, // 2: search.common.Package.layer:type_name -> search.common.Layer
	7,  // 3: search.common.Misconfiguration.successes:type_name -> search.common.MisconfResult
	7,  // 4: search.common.Misconfiguration.warnings:type_name -> search.common.MisconfResult
	7,  // 5: search.common.Misconfiguration.failures:type_name -> search.common.MisconfResult
	7,  // 6: search.common.Misconfiguration.exceptions:type_name -> search.common.MisconfResult
	0,  // 7: search.common.DetectedMisconfiguration.severity:type_name -> search.common.Severity
	11, // 8: search.common.DetectedMisconfiguration.layer:type_name -> search.common.Layer
	0,  // 9: search.common.Vulnerability.severity:type_name -> search.common.Severity
	11, // 10: search.common.Vulnerability.layer:type_name -> search.common.Layer
	18, // 11: search.common.Vulnerability.cvss:type_name -> search.common.Vulnerability.CvssEntry
	20, // 12: search.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	20, // 13: search.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	21, // 14: search.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	21, // 15: search.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	10, // 16: search.common.Vulnerability.data_source:type_name -> search.common.DataSource
	19, // 17: search.common.Vulnerability.vendor_severity:type_name -> search.common.Vulnerability.VendorSeverityEntry
	11, // 18: search.common.CustomResource.layer:type_name -> search.common.Layer
	21, // 19: search.common.CustomResource.data:type_name -> google.protobuf.Value
	14, // 20: search.common.Code.lines:type_name -> search.common.Line
	15, // 21: search.common.SecretFinding.code:type_name -> search.common.Code
	11, // 22: search.common.SecretFinding.layer:type_name -> search.common.Layer
	16, // 23: search.common.Secret.findings:type_name -> search.common.SecretFinding
	12, // 24: search.common.Vulnerability.CvssEntry.value:type_name -> search.common.CVSS
	0,  // 25: search.common.Vulnerability.VendorSeverityEntry.value:type_name -> search.common.Severity
