...
import (
	common "github.com/doapply/search/rpc/common"
...
var file_rpc_cache_service_proto_goTypes = []interface{}{
	(*ArtifactInfo)(nil),            // 0: search.cache.v1.ArtifactInfo
	(*PutArtifactRequest)(nil),      // 1: search.cache.v1.PutArtifactRequest
	(*BlobInfo)(nil),                // 2: search.cache.v1.BlobInfo
	(*PutBlobRequest)(nil),          // 3: search.cache.v1.PutBlobRequest
	(*PutResponse)(nil),             // 4: search.cache.v1.PutResponse
	(*MissingBlobsRequest)(nil),     // 5: search.cache.v1.MissingBlobsRequest
	(*MissingBlobsResponse)(nil),    // 6: search.cache.v1.MissingBlobsResponse
	(*DeleteBlobsRequest)(nil),      // 7: search.cache.v1.DeleteBlobsRequest
	(*timestamppb.Timestamp)(nil),   // 8: google.protobuf.Timestamp
	(*common.Package)(nil),          // 9: search.common.Package
	(*common.OS)(nil),               // 10: search.common.OS
	(*common.Repository)(nil),       // 11: search.common.Repository
	(*common.PackageInfo)(nil),      // 12: search.common.PackageInfo
	(*common.Application)(nil),      // 13: search.common.Application
	(*common.Misconfiguration)(nil), // 14: search.common.Misconfiguration
	(*common.CustomResource)(nil),   // 15: search.common.CustomResource
	(*common.Secret)(nil),           // 16: search.common.Secret
	(*emptypb.Empty)(nil),           // 17: google.protobuf.Empty
}
var file_rpc_cache_service_proto_depIdxs = []int32{
	8,  // 0: search.cache.v1.ArtifactInfo.created:type_name -> google.protobuf.Timestamp
	9,  // 1: search.cache.v1.ArtifactInfo.history_packages:type_name -> search.common.Package
	0,  // 2: search.cache.v1.PutArtifactRequest.artifact_info:type_name -> search.cache.v1.ArtifactInfo
	10, // 3: search.cache.v1.BlobInfo.os:type_name -> search.common.OS
	11, // 4: search.cache.v1.BlobInfo.repository:type_name -> search.common.Repository
	12, // 5: search.cache.v1.BlobInfo.package_infos:type_name -> search.common.PackageInfo
	13, // 6: search.cache.v1.BlobInfo.applications:type_name -> search.common.Application
	14, // 7: search.cache.v1.BlobInfo.misconfigurations:type_name -> search.common.Misconfiguration
	15, // 8: search.cache.v1.BlobInfo.custom_resources:type_name -> search.common.CustomResource
	16, // 9: search.cache.v1.BlobInfo.secrets:type_name -> search.common.Secret
	2,  // 10: search.cache.v1.PutBlobRequest.blob_info:type_name -> search.cache.v1.BlobInfo
	10, // 11: search.cache.v1.PutResponse.os:type_name -> search.common.OS
	1,  // 12: search.cache.v1.Cache.PutArtifact:input_type -> search.cache.v1.PutArtifactRequest
	3,  // 13: search.cache.v1.Cache.PutBlob:input_type -> search.cache.v1.PutBlobRequest
	5,  // 14: search.cache.v1.Cache.MissingBlobs:input_type -> search.cache.v1.MissingBlobsRequest
	7,  // 15: search.cache.v1.Cache.DeleteBlobs:input_type -> search.cache.v1.DeleteBlobsRequest
	17, // 16: search.cache.v1.Cache.PutArtifact:output_type -> google.protobuf.Empty
	17, // 17: search.cache.v1.Cache.PutBlob:output_type -> google.protobuf.Empty
	6,  // 18: search.cache.v1.Cache.MissingBlobs:output_type -> search.cache.v1.MissingBlobsResponse
	17, // 19: search.cache.v1.Cache.DeleteBlobs:output_type -> google.protobuf.Empty
